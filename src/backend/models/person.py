...
class Person:
    ...
    # CAMBIO CRÍTICO: De 'trusted_person_id: Optional[int]' a texto libre
    trusted_person_info: Optional[str]
    ...
    def from_dict(data: Dict[str, Any]) -> "Person":
        ...
        if isinstance(data, dict) and "first_name" in data:
            ...
            return Person(
                ...
                cdb=data.get("cdb"),
                address_id=data.get("address_id"),
                # CAMBIO: Mapeamos la propiedad de texto libre
                trusted_person_info=data.get("trusted_person_info"),
        ...
        return Person(
            ...
            # CAMBIO: Mapeamos la propiedad de texto libre
            trusted_person_info=Person._get(p, "trusted_person_info"),
